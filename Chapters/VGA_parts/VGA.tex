...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.38\textwidth}
        ...
        \caption{Transistor-level 2-way switch.}
...
\begin{figure}[H]
    ...
    \begin{minipage}[c]{0.45\textwidth}
        \centering
        \includegraphics[width=0.8\textwidth]{img/Termination_VGA_img/diff_ind.pdf} % Replace with VGA Coil Layout
...
The noise performance of the analog front-end was evaluated under the maximum gain and boost configurations (7~dB for the VGA and -15~dB DC gain for the CTLE). This setup represents the worst-case noise scenario; activating the maximum gain states opens the parallel degeneration branches, which maximizes the thermal noise contribution from the source tuning networks.

Figure~\ref{fig:vga_noise} presents the standalone noise spectral density of the VGA. When cascading the blocks, the overall noise profile at the final output is dynamically shaped by the combined AC response of the chain. Specifically, the high-frequency equalization peaking introduced by the CTLE amplifies the high-frequency thermal noise components generated by the preceding VGA and input networks. The resulting noise spectral density for the complete cascaded front-end is illustrated in Figure~\ref{fig:chain_noise}.

The integrated RMS noise, calculated across the entire 16~GHz operating bandwidth, is summarized in Table~\ref{tab:chain_noise}, detailing the specific contribution of the VGA relative to the total chain noise.

\begin{figure}[H]
    \centering
    \framebox{\includegraphics[width=0.9\textwidth]{img/Termination_VGA_img/vga_noise.png}}
    \caption{Noise spectral density of the standalone VGA at the maximum 7~dB gain configuration.}
    \label{fig:vga_noise}
\end{figure}

\begin{figure}[H]
    \centering
    \framebox{\includegraphics[width=0.9\textwidth]{img/Termination_VGA_img/chain_noise.JPG}}
    \caption{Overall noise spectral density of the cascaded front-end chain, shaped by the combined CTLE and VGA AC response.}
    \label{fig:chain_noise}
\end{figure}

\begin{table}[H]
    \centering
    \caption{Total Integrated Noise Profile}
    ...
    \begin{tabular}{@{}ll@{}}
        ...
        Total Integrated Chain Noise (RMS) & 1.514~mVrms \\ 
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \framebox{\includegraphics[width=0.95\textwidth]{img/Termination_VGA_img/chain_thd.pdf}} % Replace with Chain THD Plot
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \framebox{\includegraphics[width=0.95\textwidth]{img/Termination_VGA_img/chain_p1db.pdf}} % Replace with Chain P1dB Plot
